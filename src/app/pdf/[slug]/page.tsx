  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <Link
          href="/pdf"
          className="text-sm text-neutral-600 transition-colors hover:text-[#ff8c00]"
        >
          ← Back to PDF Library
        </Link>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-lg border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-900 shadow-sm hover:border-[#ff8c00]/40 hover:text-[#ff8c00]"
          >
            Download PDF
          </a>
        </div>
        {related.length ? (
          <section className="pt-4">
            ...
            <nav className="mt-6 rounded-2xl border border-neutral-200 bg-white/95 shadow-sm p-4">
              ...
              <ul className="mt-2 space-y-2 text-sm">
                {related.map((item) => (
                  <li key={`related-${item.id}`}>
                    <Link
                      href={buildPostUrl("pdf", item.slug)}
                      className="text-[#ff8c00] underline-offset-4 hover:underline"
                    >
                      {item.title}
                    </Link>
                  </li>
                ...
                <li>
                  <Link href="/pdf" className="text-[#ff8c00] underline-offset-4 hover:underline">
                    Browse all PDFs
                  </Link>
                </li>
              </ul>
