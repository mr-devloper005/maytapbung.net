...
import { ArrowRight, Bookmark, Building2, FileText, Globe2, Image as ImageIcon, LayoutGrid, Tag, User } from 'lucide-react'
import { ContentImage } from '@/components/shared/content-image'
import { NavbarShell } from '@/components/shared/navbar-shell'
import { Footer } from '@/components/shared/footer'
import { SchemaJsonLd } from '@/components/seo/schema-jsonld'
import { TaskPostCard } from '@/components/shared/task-post-card'
import { DirectoryListingsHome } from '@/components/home/directory-listings-home'
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {productKind === 'directory' ? <DirectoryListingsHome listingPosts={listingPosts} /> : null}
